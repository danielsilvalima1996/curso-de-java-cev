...
public class TelaTriangulo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panRespLayout.setHorizontalGroup(
            ...
            .addComponent(lblTipo, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 324, Short.MAX_VALUE)
    ...
    private void btnVerificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerificarActionPerformed
        ...
        if (a<b+c && b<a+c && c<a+b) {
            ...
            if (a==b && b==c) {
                lblTipo.setText("Equilátero"); // lados iguais
            } else if ((a!=b && b!=c && c!=a)) {
                lblTipo.setText("Escaleno"); // lados diferentes
            } else {
                lblTipo.setText("Isósceles"); // dois lados iguais
            }
        } else {
            lblStatus.setText("Não forma uma Triângulo");
            lblTipo.setText("----------");
        }
